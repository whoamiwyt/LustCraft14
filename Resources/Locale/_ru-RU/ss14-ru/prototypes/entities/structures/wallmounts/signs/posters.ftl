...
ent-PosterContrabandCC64KAd = CC 64К
...
ent-PosterContrabandMoth = Ноль Безопасности - Ядерные Операции
    .desc = Этот произведенный Синдикатом информационный плакат использует Ноль Безопасности™, чтобы показать необходимость оставлять диск ядерной аутентификации без присмотра. "Дайте войне шанс!" Никто в здравом уме в это не поверит.
ent-PosterContrabandCybersun600 = Cybersun: 600 лет
    .desc = Художественный плакат, приуроченный к 600 годам непрерывной работы Cybersun Industries.
ent-PosterContrabandDonk = БРЕНДИРОВАННЫЕ ПОЛУФАБРИКАТЫ DONK CO.
    .desc = БРЕНДИРОВАННЫЕ ПОЛУФАБРИКАТЫ DONK CO: ОТ ГОЛОДАЮЩИХ СТУДЕНТОВ, ДЛЯ ГОЛОДАЮЩИХ СТУДЕНТОВ.
ent-PosterContrabandEnlistGorlex = Вступай!
    .desc = Запишись в отряды Gorlex Marauders уже сегодня! Посмотри галактику, убей корпоратов, заработай деньжат!
ent-PosterContrabandInterdyne = Interdyne Pharmaceutics: За Здоровье Нации
    .desc = Реклама клиник генетической чистоты Interdyne Pharmaceutics. "Стань хозяином своего тела!"
ent-PosterContrabandWaffleCorp = Закупись в Waffle Corp: Хорошие Винтовки, Демократичные Цены
...
ent-PosterLegitCarpMount = Настенный карп
    .desc = Carpe diem!
ent-PosterLegitSafetyMothDelam = Моль Безопасности - Защита от Расслоения
    .desc = Этот информационный плакат использует Моль Безопасности™, чтобы показать необходимость прятаться в шкафчиках в случае расслоения Кристалла Суперматерии для защиты от галлюцинаций. Впрочем, эвакуация сработала бы лучше.
ent-PosterLegitSafetyMothEpi = Моль Безопасности - Эпинефрин
    .desc = Этот информационный плакат использует Моль Безопасности™, чтобы показать необходимость помогать коллегам в критическом состоянии при помощи эпинефринового инжектора. "Предотвратите отмирание органов одним простым методом!"
ent-PosterLegitSafetyMothHardhat = Моль Безопасности - Каски
    .desc = Этот информационный плакат использует Моль Безопасности™, чтобы показать необходимость носить каски в опасных местах. "Как лампа для головы!"
ent-PosterLegitSafetyMothMeth = Моль Безопасности - Метамфетамин
    .desc = Этот информационный плакат использует Моль Безопасности™, чтобы показать необходимость информировать Главного Врача, прежде чем начинать синтез метамфетамина. "Держитесь нужной температуры и ни в коем случае не перегревайте!" ...Ни в коем случае вам не нужно этим заниматься.
ent-PosterLegitSafetyMothPiping = Моль Безопасности - Трубопровод
    .desc = Этот информационный плакат использует Моль Безопасности™, чтобы показать необходимость подбирать правильный вид труб атмосферным техникам. "Трубы, не Насосы! Хорошая проводка сейчас предотвратит плохую работу потом!"
ent-PosterLegitVacation = Корпоративные Бонусы НаноТразен: Отпуск
    .desc = Этот информационный плакат предоставляет информацию о некоторых бонусах, доступных через программу Корпоративных Бонусов НТ, таких, как двухнедельный отпуск для двоих на курортный мир Идиллиус.
ent-PosterLegitPeriodicTable = Переодическая Таблица Элементов
    .desc = Периодическая таблица элементов, от Водорода до Оганессона, не упустив ничего.
ent-PosterLegitRenault = Алиса
    .desc = Фыр.
ent-PosterLegitNTTGC = Коллекционные Карты НаноТразен
    .desc = Рекламный плакат собственной ККИ НаноТразен: КУПИ ЭТИ КАРТЫ.
