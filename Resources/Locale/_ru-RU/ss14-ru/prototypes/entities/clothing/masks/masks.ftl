...
ent-ClothingMaskNinja = маска космического ниндзя
    .desc = Плотно прилегающая усиленная наночастицами маска, работающая как воздушный фильтр и высказывание постмодерна.
